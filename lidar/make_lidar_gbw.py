...
def main():
    ...
    img_lidar_512_save = os.path.join(root_dir, train_mode, 'images_lidar_512')
    ...
    os.makedirs(img_lidar_512_save, exist_ok=True)
    ...
    for i in tqdm(range(len(dataset))):
        img_radar, img_lidar, img_lidar_512, target, img_info = dataset[i]
        ...
        img_lidar_512_save_path = os.path.join(img_lidar_512_save, str(i).zfill(5)+'.png')
        ...
        cv2.imwrite(img_lidar_512_save_path, img_lidar_512)
